      ...
      <div className="mobile-wrapper">
        <div className="top-nav">
          ...
          <div style={{display: 'flex', gap: 10}}>
            ...
            <button className="logout-btn" style={{background: viewMode === 'history' ? '#6366f1' : 'var(--bg-input)', color: viewMode === 'history' ? 'white' : 'var(--text-main)'}} onClick={() => setViewMode(viewMode === 'pending' ? 'history' : 'pending')}>
              <FileText size={18}/>
            </button>
